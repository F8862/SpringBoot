...
public class UserController {
	...
	public String createOrder(@RequestBody Map<String,Object> data,Principal principal) throws Exception {
		...
		RazorpayClient client = new RazorpayClient("rzp_test_oNev6IkaoHm5lt", "n5PRczuaXUXfOtaj3eBdyjyF");
		JSONObject ob=new JSONObject();
		ob.put("amount", amt*100);//convert amount into paisa from rupee
		ob.put("currency", "INR");
		ob.put("receipt", "txn_12345");
		//creating new order
		Order order = client.Orders.create(ob);
		System.out.println(order);
		//if we want we can save this into our db..
